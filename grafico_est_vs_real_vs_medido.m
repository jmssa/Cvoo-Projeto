...
nexttile;
plot(t, rad2deg(p_est),'r', t, rad2deg(p), 'blue', 'LineWidth', 1.5);
xlabel('Tempo (s)', 'FontSize', 14);
...
nexttile;
plot(t, rad2deg(p_lido), 'green', 'LineWidth', 1.5);
xlabel('Tempo (s)', 'FontSize', 14);
ylabel('Razão (°/s)', 'FontSize', 14);
ylim([-30, 30]);
title('Razão de rolamento medida pelo sensor', 'FontSize', 14);
grid on;

nexttile;
plot(t, rad2deg(r_est),'r', t, rad2deg(r), 'blue', 'LineWidth', 1.5);
xlabel('Tempo (s)', 'FontSize', 14);
ylabel('Razão (°/s)', 'FontSize', 14);
title('Razão de guinada', 'FontSize', 14);
legend('Valor Real', 'Valor lido');
grid on;

nexttile;
plot(t, rad2deg(r_lido), 'green', 'LineWidth', 1.5);
xlabel('Tempo (s)', 'FontSize', 14);
ylabel('Razão (°/s)', 'FontSize', 14);
ylim([-20, 20]);
title('Razão de guinada medida pelo sensor', 'FontSize', 14);
grid on;

nexttile;
plot(t, rad2deg(psi_est),'r', t, rad2deg(psi), 'blue', 'LineWidth', 1.5);
xlabel('Tempo (s)', 'FontSize', 14);
ylabel('Ângulo (°)', 'FontSize', 14);
...
nexttile;
plot(t, rad2deg(psi_lido), 'green', 'LineWidth', 1.5);
xlabel('Tempo (s)', 'FontSize', 14);
ylabel('Ângulo (°)', 'FontSize', 14);
title('Ângulo de guinada medido pelo sensor', 'FontSize', 14);
grid on;